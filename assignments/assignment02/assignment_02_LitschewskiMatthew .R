...
## Use `setwd()` if needed
setwd("/Users/matthewlitschewski/Documents/GitHub/dsc520/data")
getwd()

## Load the file `data/tidynomicon/person.csv` to `person_df1` using `read.csv`
## Examine the structure of `person_df1` using `str()`
person_df1 <- read.csv(file = "/Users/matthewlitschewski/Documents/GitHub/dsc520/data/tidynomicon/person.csv" )
str(person_df1)
...
person_df2 <- read.csv(file = "/Users/matthewlitschewski/Documents/GitHub/dsc520/data/tidynomicon/person.csv", stringsAsFactors = FALSE)
str(person_df2)
...
excel_sheets("/Users/matthewlitschewski/Documents/GitHub/dsc520/data/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("/Users/matthewlitschewski/Documents/GitHub/dsc520/data/G04ResultsDetail2004-11-02.xls", sheet = 'Voter Turnout', skip = 1)
...
voter_turnout_df2 <- read_excel("/Users/matthewlitschewski/Documents/GitHub/dsc520/data/G04ResultsDetail2004-11-02.xls",col_name  = c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout"), sheet = 'Voter Turnout', skip = )
...
db <- dbConnect(RSQLite::SQLite(), "/Users/matthewlitschewski/Documents/GitHub/dsc520/data/tidynomicon/example.db" )
